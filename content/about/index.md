...
Hi, I'm Ben — a Technical Architect working in the Office of the CTO at the Microsoft Innovation Hub for Germany and Austria. With over 15 years of international experience in enterprise architecture, End-User Computing, and cloud technologies, I operate at the intersection of technology strategy, AI transformation, and customer impact.

Born on premise — living in the cloud. I started my career racking servers and managing on-prem infrastructure. Today I partner with Microsoft's most strategic enterprise customers to shape end-to-end architectures that turn vision into reality. I think in systems — connecting technology, business, and people to deliver outcomes at scale.

---

## Impact at a Glance

- **75,000+ Cloud PCs & 100,000+ Virtual Machines** — Architected and won the largest Windows 365 and Azure Virtual Desktop environments worldwide
- **36 Advanced Cloud Experts** — Built and led a cross-EMEA technical team, reporting into the COO
- **1,200+ Cloud Solution Architects** — Trained through technical bootcamps and readiness programs I designed and co-founded
- **15+ cross-EMEA initiatives** — From go-to-market accelerators to strategic sales plays for Azure Virtual Desktop and HPC
- **Published author** — Contributed to the Azure Well-Architected Framework, Cloud Adoption Framework, and Architecture Center documentation
...
In five years I grew from an individual contributor to leading a 36-person technical organisation across EMEA, and then moved into the Office of the CTO. Today I shape end-to-end architecture and AI transformation strategies for Microsoft's most strategic customers across Germany and Austria — partnering directly with product engineering to turn customer needs into roadmap influence.

Along the way I reported into the COO of EMEA, co-founded Azure Bootcamps at scale, authored Azure framework documentation, and architected the largest Windows 365 and AVD deployments worldwide. I was recognised with the **Microsoft Pinnacle Award** — awarded to just 43 individuals (0.007%) across the entire company — for outstanding leadership, community impact, and customer outcomes.
...
- **Author** — Azure Well-Architected Framework, Cloud Adoption Framework, and Architecture Center contributions
...
Most AI transformations fail not because the technology isn't ready — but because organisations skip the architecture. They jump to models and demos without solving for data gravity, governance, or change management. I've made it my job to fix that gap.

My leadership philosophy is simple: lead by example, inspire with passion, and hit refresh every day. I care about making complex technology accessible and useful — not just technically possible. And I've found that the best way to grow is to empower others to exceed their own goals.
