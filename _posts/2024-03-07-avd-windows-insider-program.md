...
description: "Learn how to enable Windows Insider Preview builds on your AVD session hosts or Windows 365 Cloud PCs for early access to new features."
date: 2024-03-07
category: guide
tags:
  - AVD
...
If so, you might want to consider joining the Windows Insider Program. This program allows you to preview builds of the upcoming release of Windows and provide feedback to help shape the future of the operating system.
...
- **Canary Channel**: For highly technical users and for updates in an early development cycle
- **Dev Channel**: For the earliest access to new features
- **Beta Channel**: For slightly more stable builds
- **Release Preview Channel**: For the most stable preview builds

> **Note:** For the AVD Public Preview clipboard transfer direction and data types you need the Dev-Channel Insider Preview Build (25898 or higher).
...
- [Announcing Windows 11 Insider Preview Build 26058](https://blogs.windows.com/windows-insider/2024/02/14/announcing-windows-11-insider-preview-build-26058-canary-and-dev-channels/)
- [The Windows Insider Program](https://www.microsoft.com/windowsinsider/)
